...
{findings_html}
    ...
    <div class="section">
        <h2>Footer</h2>
        <p>Report generated by Cyber-Defense-Shield v1.3</p>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Comprehensive Security Assessment Report v1.3</p>
            <p>Generated: {datetime.now().strftime("%Y-%m-%d %H:%M:%S")}</p>
        </div>
        
        <div class="section">
            <h2>Executive Summary</h2>
            <p>This comprehensive report provides a detailed security assessment of your system using Cyber-Defense-Shield v1.3.</p>
        ...
        <div class="footer">
            <p><strong>Cyber-Defense-Shield v1.3</strong></p>
